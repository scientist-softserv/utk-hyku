  ...
  module Forms
    ...
    class CollectionForm
      ...
      def logo_info
        @logo_info ||= begin
          ...
          logos_info.map do |logo_info|
            ...
            { file: logo_file, full_path: logo_info.local_path,
              relative_path: relative_path, alttext: alttext, linkurl: linkurl }
          end
        end
      end
      ...
      def available_parent_collections(scope:)
        ...
        colls = Hyrax::Collections::NestedCollectionQueryService.available_parent_collections(
          child: collection, scope: scope, limit_to_id: nil
        )
      ...
      private
        ...
        def collection_member_service
          @collection_member_service ||= membership_service_class.new(scope: scope,
